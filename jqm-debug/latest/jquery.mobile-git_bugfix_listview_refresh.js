...
$.widget( "mobile.listview", $.extend( {
	...
	_create: function() {
		...
		this.element.addClass( " ui-listview" );
	...
	refresh: function( create ) {
		var buttonClass, pos, numli, item, itemClass, itemTheme, itemIcon, icon, a,
			...
			altButtonClass, dividerTheme, li, first,
			o = this.options,
			$list = this.element,
			...
			_removePrevClass = function( target ) {	// clear themes & icons
				var prevClass = target[ 0 ].className.match( /\bui-btn-\w\b|\bui-icon-[\w-]+\b/g );
				if ( prevClass ) {
					target.removeClass( prevClass.join( " " ) );
				}
			};

		if ( !!o.inset ) {
			$list.addClass( "ui-listview-inset" );
			$list[ o.corners ? "addClass" : "removeClass" ]( "ui-corner-all" );
			$list[ o.shadow ? "addClass" : "removeClass" ]( "ui-shadow" );
		} else {
			$list.removeClass( "ui-listview-inset ui-corner-all ui-shadow" );
		}
