...
$.widget( "mobile.selectmenu", $.mobile.selectmenu, {
	...
	build: function() {
		...
		if ( !o.overlayTheme ) {
			o.overlayTheme = o.theme;
		}

		if ( !o.dividerTheme ) {
			o.dividerTheme = o.overlayTheme;
		}
		...
		dividerThemeAttr = o.dividerTheme ? ( " data-" + $.mobile.ns + "divider-theme='" + o.dividerTheme + "'" ) : "";
		menuPage = $( "<div data-" + $.mobile.ns + "role='dialog' class='ui-selectmenu' id='" + dialogId + "'" + themeAttr + overlayThemeAttr + ">" +
			"<div data-" + $.mobile.ns + "role='header'" + overlayThemeAttr + ">" +
			"<div class='ui-title'>" + label.getEncodedText() + "</div>"+
			"</div>"+
			"<div data-" + $.mobile.ns + "role='content'></div>"+
			"</div>" );
		listbox = $( "<div id='" + popupId + "' class='ui-selectmenu'>" ).insertAfter( this.select ).popup({ theme: o.overlayTheme });
		list = $( "<ul class='ui-selectmenu-list' id='" + menuId + "' role='listbox' aria-labelledby='" + this.buttonId + "'" + overlayThemeAttr + dividerThemeAttr + ">" ).appendTo( listbox );
		header = $( "<div class='ui-header ui-bar-" + ( o.overlayTheme ? o.overlayTheme : "inherit" ) + "'>" ).prependTo( listbox );
