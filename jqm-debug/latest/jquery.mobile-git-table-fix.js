...
* Git HEAD hash: 6016aecacb4f84265a0c0ff91285b0d02cc0045f <> Date: Thu Oct 24 2013 20:14:41 UTC
...
$.widget( "mobile.table", {
	...
	option: function ( key, value ) {
		if ( key === "classes" && value === undefined ) {
			return $.extend( {}, this.options.classes );
		}
	...
	_setOption: function( key, value ) {
		if ( key === "classes" ) {
			if ( typeof value === "object" ) {
				console.log ( "extend option. ");
				$.extend( this.options.classes, value );
			}
			return this;
		}
		return this._super( key, value );
...
$.widget( "mobile.table", $.mobile.table, {
	...
	_setOption: function( key, value ) {
		var cells;
		// var thisClasses = this.options.classes,
		// 	optClasses = options.classes,
		// 	reflowTable = optClasses ? optClasses.reflowTable : undefined,
		// 	cellLabels = optClasses ? optClasses.reflowTable : undefined,

		console.log("\t_setOption : before key : " + key + " - value : " + this.options.classes.cellLabels );
		if ( value.cellLabels && value.cellLabels === this.options.classes.cellLabels ) {
			cells = this.element.find( "." + this.options.classes.cellLabels );
			cells.removeClass( this.options.classes.cellLabels ).addClass( value.cellLabels );
			this.options.classes.cellLabels = value.cellLabels;
		} 
		// else {
		// 	value.cellLabels = this.options.classes.cellLabels;
		// }

		this._super(key, value);
		console.log("\t_setOption : after key : " + key + " - value : " + this.options.classes.cellLabels );
